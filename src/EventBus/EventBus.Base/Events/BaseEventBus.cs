...
namespace EventBus.Base.Events
{
	public abstract class BaseEventBus : IEventBus, IDisposable
	{
		...
		{
			eventName = eventName.StartsWith(EventBusConfig.EventNamePrefix) ? eventName.Substring(EventBusConfig.EventNamePrefix.Length) : eventName;
			eventName = eventName.EndsWith(EventBusConfig.EventNameSuffix) ? eventName.Substring(0, eventName.Length - EventBusConfig.EventNameSuffix.Length) : eventName;
